...
<html lang="TR" dir="ltr">
  ...
  <body
    ...
    <main>
                ...
                <div class="absolute top-1/3 lg:top-[12%] inline-block animate-fly rounded-2lg border-2 border-[#caa754] bg-white p-3 lg:p-4 2xl:p-6 shadow-2xl sm:left-[5%] md:left-20 lg:-left-0 2xl:left-[8%]">
                  <div class="flex gap-4">
                    ...
                    <div class="text-left">
                      ...
                      <span class="block font-display text-sm text-jacarta-600">3,030 TL</span>
                    </div>
                  </div>
                </div>
                  <picture>
      ...
      <section id="cryptochart" class=" dark:bg-jacarta-900 -translate-y-24 lg:-translate-y-32 2xl:-translate-y-36 -mb-12">
          <div class="scrollbar-custom overflow-x-auto py-4">
            ...
            <div class="rounded-lg bg-white dark:bg-jacarta-700 dark:text-jacarta-300 container" style="box-shadow: 0 0 20px 10px #f9f4d59e;">
              <div class="flex items-center border-b border-jacarta-600 dark:border-jacarta-600">
                <div class="text-xl font-bold w-[25%] px-3 py-5 text-center text-[#caa754]">İsim</div>
                ...
                <div class="text-xl font-bold w-[15%] px-3 py-5 text-center text-[#caa754]">Fark</div>
                <div class="text-xl font-bold w-[20%] px-3 py-5 text-center text-[#caa754]">İşlem</div>
              </div>
              ...
              <ul class="nav nav-tabs mb-12 space-y-2" role="tablist">
                    ...
                    <div>
                      ...
                      <div class="nav-link-content hidden">
                        <p class="text-jacarta-500 dark:text-jacarta-300">
                          Milyem Gold dünyasına adım atmak için basit bir üyelik işlemiyle kendi hesabını oluştur.
                        </p>
                      </div>
                    </div>
                  </button>
                ...
                <li class="nav-item" role="presentation">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div class="nav-link-content hidden">
                        <p class="text-jacarta-500 dark:text-jacarta-300">
                          Güvenlik doğrulamalarını tamamlayarak hesabını koruma altına al ve işlemlerini güvenle yap.
                        </p>
                      </div>
                    </div>
                  </button>
                ...
                <li class="nav-item" role="presentation">
                  ...
                  >
                      ...
                      <div class="nav-link-content hidden">
                        <p class="text-jacarta-500 dark:text-jacarta-300">
                          Satın almak istediğin miktarı belirle ve dijital altınlarını kolayca sepete ekle.
                        </p>
                      </div>
                    </div>
                  </button>
                ...
                <li class="nav-item" role="presentation">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div class="nav-link-content hidden">
                        <p class="text-jacarta-500 dark:text-jacarta-300">
                          Güvenilir ödeme yöntemleriyle işlemini hızlıca tamamla ve dijital altın sahibi ol.
                        </p>
                      </div>
                    </div>
                  </button>
                ...
                <li class="nav-item" role="presentation">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div class="nav-link-content hidden">
                        <p class="text-jacarta-500 dark:text-jacarta-300">
                          Profilinden sipariş durumunu görüntüle, sahip olduğun Milyem'lere anında eriş.
                        </p>
                      </div>
                    </div>
                  </button>
                ...
                <li class="nav-item" role="presentation">
                  ...
                  >
                      ...
                      <div class="nav-link-content hidden">
                        <p class="text-jacarta-500 dark:text-jacarta-300">
                          Dilediğinde dijital Milyem'lerini gram altına çevir ve fiziki olarak teslim al. İşlem ücreti ödeyeceğini unutma!
                        </p>
                      </div>
                    </div>
                  </button>
          ...
          <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div class="relative rounded-2.5xl border border-jacarta-100 bg-white p-8 shadow-[0_5px_0_0_#AB842E] transition-shadow hover:shadow-[0_16px_24px_-8px_rgba(171,132,46,.3)] dark:border-jacarta-700 dark:bg-jacarta-700">
              ...
              <p class="dark:text-jacarta-300">
                Altın yatırımlarınızı ekstra masrafsız, doğrudan değerinde yapın.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p class="dark:text-jacarta-300">
                Tarihi güven ve deneyimle altın alım satımında güvenilirlik.
              </p>
            </div>
            <div
              class="relative rounded-2.5xl border border-jacarta-100 bg-white p-8 shadow-[0_5px_0_0_#AB842E] transition-shadow hover:shadow-[0_16px_24px_-8px_rgba(171,132,46,.3)] dark:border-jacarta-700 dark:bg-jacarta-700"
            >
              ...
              <p class="dark:text-jacarta-300">
                küçük miktarlarla altın yatırımına başlayarak birikimlerinizi değerlendirin.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide !h-auto">
          <div class="h-full rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
            ...
            <p class="dark:text-jacarta-300">
              Fiziki altın elde edebilmek için en az 1000 MİLYEM gerekmektedir. 1000 ve 1000' in katları gram altına dönüştürülebilir.
            </p>
          </div>
        </div>
        ...
        <div class="swiper-slide !h-auto">
          <div class="h-full rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
            ...
            <p class="dark:text-jacarta-300">
              İstediğin fiziki altın ağırlığına göre farklı ücret çıkacaktır. Ücret farkını da tamamladıktan işlem başlayacaktır.
            </p>
          </div>
        </div>
        <div class="swiper-slide !h-auto">
          <div class="h-full rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
            ...
            <p class="dark:text-jacarta-300">
              Tüm işlemler tamamlandıktan sonra teslimat için gerekli işlemleri yapacağız ve takip edebilmen için seni bilgilendireceğiz.
            </p>
          </div>
        </div>
        <div class="swiper-slide !h-auto">
          <div class="h-full rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
            ...
            <p class="dark:text-jacarta-300">
              Kapalı Çarşı Derneği güvencesiyle milyemlerin fiziksel altına dönüştü.
            </p>
          </div>
        </div>
      </div>
      ...
      <section class="relative py-24 dark:bg-jacarta-800">
        <div class="container">
          <div class="justify-between lg:flex lg:space-x-20">
            <div class="lg:w-[70%]">
              <h2 class="mb-6 font-display text-3xl font-medium text-jacarta-700 dark:text-white">
              ...
              <p class="text-lg text-jacarta-700 dark:text-jacarta-100 text-center">
                <a href="/sikca-sorulan-sorular.php" class="inline-flex items-center justify-center text-lg text-[#caa754]">
                  Tümünü Görüntüle
...
<!--                <img src="/img/milyem/faq.png" class="mb-8 inline-block rounded-2.5xl" />-->
      ...
      <section class="overflow-hidden pb-24 dark:bg-jacarta-900">
        <div class="container">
          <div class="mx-auto mb-14 max-w-xl text-center">
            <h2 class="mb-6 text-center font-display text-3xl font-medium text-jacarta-700 dark:text-white">
              Milyem ile Fiziki Altın Alabileceğiniz Yerler
            </h2>
          </div>
        </div>
      ...
      <section class="relative bg-cover bg-center bg-no-repeat py-16 after:absolute after:inset-0 after:bg-[#000000]/50" style="background-image: url(img/milyem/dark-image-bg.png)">
        ...
        <div class="mx-auto mt-10 max-w-md text-center">
          <form class="relative">
            <input
              ...
              class="w-full rounded-full border border-jacarta-600 bg-white py-3 px-4 text-black placeholder-black focus:ring-[#caa754]"
            />
            <button
              class="absolute top-2 right-2 rounded-full bg-[#caa754] px-6 py-2 font-display text-sm text-white hover:bg-[#caa754]-dark"
            >
              Gönder
            </button>
          </form>
      ...
      try {
        ...
        wantedSymbols.forEach(symbol => {
          ...
          row.innerHTML = `
                ...
                <div class="crypto-price__trade w-[20%] pl-3 pr-4 py-5 text-center font-display text-lg"><a href="/satin-al.php" class="rounded-full hover:bg-jacarta-700 bg-green px-5 py-2 text-white font-display font-semibold text-lg">Satın Al</a></div>
              `;
