...
<html lang="TR" dir="ltr">
  <head>
      <title>Cüzdanım | Milyem Gold</title>
  ...
  <body class="overflow-x-hidden font-body text-jacarta-500 dark:bg-jacarta-900" itemscope itemtype="http://schema.org/WebPage">
    ...
    <main>
        ...
        <section class="relative py-24">
            ...
            <div class="container">
                <h1 class="py-16 text-center font-display text-4xl font-medium text-jacarta-700 dark:text-white">Cüzdanım</h1>
                        ...
                        <div class="flex-wrap flex justify-center">
                            <div class="w-1/2 p-3 pt-0 dark:border-jacarta-600 dark:bg-jacarta-700 mb-12">
                                <div class=" rounded-2.5xl border border-jacarta-100 bg-white text-center transition-shadow hover:shadow-xl">
                                    ...
                                    <h3 class="mb-4 font-display text-xl text-jacarta-700 dark:text-white">1458 TL</h3>
                                    <div class="flex space-x-4 justify-around w-full mb-4">
                                        <div class="cursor-pointer group flex items-center rounded-2.5xl border border-[#caa754] bg-white py-4 px-3 2xl:px-5 transition-shadow group-hover:shadow-lg dark:border-transparent dark:bg-jacarta-700" onclick="window.location.href='/satin-al.php';">
                                            <a href="/satin-al.php" class="block">
                                                <span class="font-bold text-base text-jacarta-700 group-hover:text-[#caa754] dark:text-white whitespace-nowrap">TL Yatır</span>
                                            </a>
                                        </div>
                                        <div class="cursor-pointer group flex items-center rounded-2.5xl border border-[#caa754] bg-white py-4 px-3 2xl:px-5 transition-shadow group-hover:shadow-lg dark:border-transparent dark:bg-jacarta-700" onclick="window.location.href='/satin-al.php';">
                                            <a href="#" class="block">
                                                <span class="font-bold text-base text-jacarta-700 group-hover:text-[#caa754] dark:text-white whitespace-nowrap">TL Çek</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
